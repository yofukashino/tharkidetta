...
export const patchChannelItem = () => {
  storage.faded ??= defaultSettings.faded;
    const unpatchView  = Patcher.after(
        ...
        View,
      function (_args, res) {
        const channelItem = Utils.findInReactTree(res, (c) => c?.props?.channel  && !c?.props?.channel?.isCategory?.() && c?.props?.isRulesChannel !== void 0 && c?.props?.muted !== void 0 && c?.props?.channel?.guild_id !== null && typeof c?.type?.type === "function");
